// ─── Order Models & Mock Data ───
import type { IntegrationType, OrderStatus, OrderTimeline, Order } from "@/services/types";
import { MOCK_SUPPLIERS } from "@/services/mockStore";

export type { IntegrationType, OrderStatus, OrderTimeline, Order };

// ─── Mock Orders ───

export const MOCK_ORDERS: Order[] = [
  {
    id: "ORD-2026-001", bookingId: "BK-2026-001", listingId: "w1",
    listingTitle: "Laobox Tallinn Kesklinn", listingType: "warehouse",
    supplierId: "sup-1", supplierName: "Laobox OÜ", integrationType: "api",
    customerName: "Andres Tamm", customerEmail: "andres@email.com", customerPhone: "+372 5551 2345",
    city: "Tallinn", startDate: "2026-04-01", endDate: "2026-06-30", duration: "3 kuud",
    extras: ["Kindlustus"], basePrice: 147, platformPrice: 140, supplierPrice: 125, extrasTotal: 30, total: 170, margin: 15,
    status: "confirmed", createdAt: "2026-03-18 14:23", sentAt: "2026-03-18 14:23", confirmedAt: "2026-03-19 09:15",
    timeline: [
  ...
  {
    id: "ORD-2026-002", bookingId: "BK-2026-002", listingId: "m1",
    listingTitle: "KoliExpress", listingType: "moving",
    supplierId: "sup-4", supplierName: "KoliExpress OÜ", integrationType: "email",
    customerName: "Kati Mets", customerEmail: "kati@email.com", customerPhone: "+372 5123 9876",
    city: "Tallinn", startDate: "2026-03-25", duration: "Ühekordne",
    extras: ["Pakkimisabi", "Laadimisabi"], basePrice: 180, platformPrice: 171, supplierPrice: 153, extrasTotal: 35, total: 206, margin: 18,
    status: "sent", createdAt: "2026-03-20 10:45", sentAt: "2026-03-20 10:46",
    timeline: [
  ...
  {
    id: "ORD-2026-003", bookingId: "BK-2026-003", listingId: "t1",
    listingTitle: "HaagisRent Tallinn", listingType: "trailer",
    supplierId: "sup-5", supplierName: "HaagisRent OÜ", integrationType: "manual",
    customerName: "Jüri Kask", customerEmail: "jyri@email.com", customerPhone: "+372 5234 5678",
    city: "Tallinn", startDate: "2026-03-10", endDate: "2026-03-12", duration: "2 päeva",
    extras: [], basePrice: 50, platformPrice: 48, supplierPrice: 43, extrasTotal: 0, total: 48, margin: 5,
    status: "completed", createdAt: "2026-03-08 16:30", sentAt: "2026-03-08 16:35", confirmedAt: "2026-03-09 08:00",
    timeline: [
  ...
  {
    id: "ORD-2026-004", bookingId: "BK-2026-004", listingId: "w2",
    listingTitle: "MiniLadu Tartu", listingType: "warehouse",
    supplierId: "sup-2", supplierName: "MiniLadu AS", integrationType: "email",
    customerName: "Maria Saar", customerEmail: "maria@email.com", customerPhone: "+372 5345 6789",
    city: "Tartu", startDate: "2026-04-15", endDate: "2026-07-15", duration: "3 kuud",
    extras: [], basePrice: 87, platformPrice: 83, supplierPrice: 74, extrasTotal: 0, total: 83, margin: 9,
    status: "rejected", createdAt: "2026-03-19 11:20", sentAt: "2026-03-19 11:21",
    timeline: [
...
export function getSupplierForListing(listingId: string) {
  ...
  const supplierId = map[listingId];
